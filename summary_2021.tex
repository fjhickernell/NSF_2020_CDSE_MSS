...
This project will extend the scope of application of QMC sampling to areas such as big data analytics, Bayesian inference,  machine learning, probabilistic numerics through theoretical and methodological advances.  This will involve advances in variation/variance reduction, new stopping criteria, \FJHNote{help me}.
