...
\begin{itemize}
\item \textit{Task 3.5.1}: While the existence of such a LD subset is promising, one challenge lies in finding this subset efficiently. 
\item \textit{Task 3.5.2}: evaluation time independent of $N$.
\end{itemize}   
