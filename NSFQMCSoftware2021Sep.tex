...
\begin{enumerate}[i.]
    ...
    \begin{enumerate}[a)]
        ...
        \item QMC algorithms, including automatic stopping criteria, adaptive variance/variation reduction methods (\cref{sec:varred}), multilevel algorithms (\cref{sec:multilevel}), big data analytics, and Bayesian computation, and
