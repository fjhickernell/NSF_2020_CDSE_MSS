...
Bayesian optimization applies this probabilistic numerics perspective to finding the minimum of an objective function.  The next location for can be posed as the 
