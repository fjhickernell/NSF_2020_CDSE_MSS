...
\begin{figure}
	\centering
	\includegraphics[height = 5. cm]{ProgramsImages/sample_data.png} 
	\includegraphics[height = 5. cm]{ProgramsImages/qEI_cost_comp_time.png} 
	\includegraphics[height = 5. cm]{ProgramsImages/qEI_cost_comp_n.png} 
	\caption{Number of function values (left) and run time (right) required to compute the Keister integral \eqref{eq:Keister} using QMCPy.  LD sampling is much more efficient than IID sampling, especially as the error tolerance decreases.}
	\label{fig:qei}
\end{figure}
