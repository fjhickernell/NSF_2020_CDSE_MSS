...
\subsubsection{LD posterior sampling for Bayesian learning}
...
One possible approach is to use the kernel discrepancy (8) to generate 
...
Bayesian optimization is a relatively unexplored QMC application area.  We will explore the \emph{efficacy of LD sampling} in Bayesian optimization and other probabilistic numerics problems.
