...
\subsubsection{LD Data Squashing for Big Data Learning}
...
\subsubsection{LD Posterior Sampling for Complex Bayesian Models}
...
Stein points \citep{chen2018stein}: Stein's identity, gets rid of dependency on normalizing constant. Minimum energy points, weighted Reisz points, Damelin paper. PI has also worked on expensive Bayesian problems (bingham, ae papers). We will implement this in QMCPy and explore the effectiveness of these methods for complex Bayesian learning problems.
