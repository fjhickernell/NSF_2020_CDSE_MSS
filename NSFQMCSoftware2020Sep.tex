...
For comparison purposes, QMCPy also has standard uniform and normal psuedo-random generators adapted from \pyinline{numpy}.  
...
To construct good points that mimic distributions other than standard uniform, one must transform the original points.  The  inverse cumulative distribution is typically used.  The \pyinline{TrueMeasure} class automates that transformation.
\begin{pythoncode}
