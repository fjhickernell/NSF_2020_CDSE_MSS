...
With significant advances in experimental technology, mathematical modeling, and computing power, big data is ubiquitous in nearly every scientific field. To use such data for real-time decision-making, efficient learning algorithms for scientific inference and predictive modeling. The development of scalable algorithms for big data is a key topic in statistical learning and computer science.
...
Stein points \citep{chen2018stein}: Stein's identity, gets rid of dependency on normalizing constant. Minimum energy points, weighted Reisz points, Damelin paper. We will implement this in QMCPy and explore the effectiveness of these methods for complex Bayesian learning problems.
