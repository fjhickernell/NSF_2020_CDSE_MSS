...
FH gave a tutorial on QMC software---with a focus on QMCPy at MCQMC 2020 \cite{MCQMC2020QMCPyTut}.  A Google Colaboratory notebook \cite{QMCPyTut2020} was made available for the audience to try QMCPy simultaneously with the tutorial.  A series of blogs to introduce the broader community to QMC was developed \cite{QMCBlog}.



\subsection{The Architecture of QMCPy}

QMCPy may be installed using \mintinline{python}{pip} and imported via \mintinline{python}{from qmcpy import *}
