...
\FH, \YD, \SCTC, \MM, \JR, \AS and collaborators have developed more comprehensive \QMC libraries, GAIL \cite{ChoEtal21a} for \MATLAB and \QMCPy \cite{QMCPy2020a} for Python.  These libraries include the stopping criteria mentioned above, as well as flexible variable transformations of the form \eqref{eq:vartrans}.  Our recent effort has been focused on \QMCPy, and includes tutorials, and 


\subsection{Limitations of Existing Methodology and Software}

There are several limitations to the methodology described above, which our proposed research addresses.
