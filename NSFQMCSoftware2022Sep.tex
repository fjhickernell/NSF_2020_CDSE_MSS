...
As mentioned in \cref{sec:lowdiscrep,sec:stopcrit}, \FH, \YD, \SCTC, \AS, \MM, \JR, \PR, and collaborators have created the Python QMC library QMCPy.  QMCPy includes LD sequences, basic variable transformations, and stopping rules
