...
\paragraph{\textit{Unfunded collaborators.}} The PIs are part of a broad network of computational mathematicians and statisticians, including quasi-Monte Carlo (QMC) theorists and practitioners.  In the supplemental attachments, we have included letters of collaboration from a few key collaborators on this project, should the project be funded.
...
\paragraph{\textit{Shot-term visitors:}} Some scholars whose expertise would be immensely helpful to the goals of this project will be hosted at Illinois Tech and/or Duke U.
